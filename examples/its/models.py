...
class ITSMAPPOModel(TorchRNN, nn.Module):
    def __init__(
        self,
        obs_space,
        action_space,
        ...
        **kwargs,
        ...
        if coordinator_hiddens is None:
            coordinator_hiddens = [256, 256]
        ...
        self.coordinator_hiddens = coordinator_hiddens or []
        self.critic_hiddens = critic_hiddens or list(self.actor_hiddens)
        self.actor_hidden_activation = actor_hidden_activation
        self.coordinator_hidden_activation = coordinator_hidden_activation
...
ModelCatalog.register_custom_model('ITSMAPPOModel', ITSMAPPOModel)
